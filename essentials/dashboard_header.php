    ...
    if ( $active == "index_large" ) {
        ...
        <header id="action_classic_header" class="h_header_index top-xs top-sm top-md middle-lg center-xs center-sm center-md center-lg">
            <div class="row h_row_container middle-xs middle-sm middle-md middle-lg center-xs center-sm center-md center-lg">
                <div class="col-xs-5">
                    <h1 onclick="location.href='/';" class="h_cursor_pointer">Vacayournal</h1>
                </div>        
                <div class="col-xs-7">
             ...
             <div class="row middle-xs" style="height: 150px;">
                 <div class="col-xs-12">
                    <div class="row middle-xs center-xs" style="height: 100px">
                        <div class="col-xs-3">
                         <div class="row">
                            <h1 onclick="location.href='/';" title="Vacayournal" class="b_logo_small">V</h1>
                            <h1 onclick="location.href='/help/';" title="Hilfe und Support" class="b_help_title">Hilfe und Support</h1>
                            </div>
                        </div>           
                        <div class="col-xs-3">
                        ...
                        <div class="col-xs-3">
                            <div class="row middle-xs center-xs">
                                <div class="col-xs-3">
                                    <button type="button" class="b_header_link" onclick="location.href='/?sSpecial=l'">Anmelden</button>
                                </div>
                                <div class="col-xs-3">
                                    <button type="button" class="b_header_link" onclick="location.href='/?sSpecial=r'">Registrieren</button>
                                </div>
                            </div>
                        </div>  
                    </div>
...
EOF;
    ...
    <header class="h_header middle-xs center-xs">
       <div class="col-xs-3">
           <div class="row middle-xs">
               <div class="col-xs-1 h_hover_able" title="Startseite">
                    <div onclick="location.href='/dashboard';" class="row middle-xs center-xs" style="margin-top: 7.5px;">
       ...
       <div class="col-xs-4">
           <div class="row middle-xs">
               <div class="col-xs-6 center-xs middle-xs" style="min-width: fit-content;max-width: fit-content; padding: 0;" onclick="location.href='/dashboard/user/?cUserId=${sUserId}'">
               ...
               <div class="col-xs-3 row center-xs middle-xs">
                    ...
                    <div class="col-xs-4 row middle-xs center-xs">
                        <button title="Nachrichten" onclick='location.href="/chat"'>
                    ...
                    <div class="col-xs-4 row middle-xs center-xs" style="position: relative;">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                              ...
                              <a href="/help/">Hilfe</a>
                              <hr style="margin: 0">
                              <a href="/dashboard/settings/">Feed-Einstellungnen</a>
                              <a href="/dashboard/settings/">Einstellungnen</a>
                              <a onclick='if (confirm("Willst du dich wirklich von Vacayournal abmelden?")) { location.href="/auth/logout.php" }' href="#">Abmelden</a>
                            </div>
                        </div>
                    </div>
                </div> 
