function sendMessage( send_to_user ) {
    ...
    if (message.length === 0) {
        ...
        xmlhttp.open("GET", "/website/chat/chat_send.php?message=" + message + "&user=" + send_to_user, true);
        xmlhttp.send();
    }
}
...
function call( last_action_user ) {
    ...
    xmlhttp.open("GET", "/website/chat/chat_callback.php?cUser=" + last_action_user , true);
    xmlhttp.send();
}
...
function CallUserSection( user_id, section ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/user/user_callback.php?cUserId=" + user_id + "&cSection=" + section , true);
    xmlhttp.send();
}
...
function CallAdd( action ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/add_callback.php?aAction=" + action, true);
    xmlhttp.send();
}
...
function SelectPrecision () {
    ...
    xmlhttp.open("GET", "/website/dashboard/precision_callback.php?cOption=" + value, true);
    xmlhttp.send();
}
...
function CallFollow( userid, action ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/follow_callback.php?cFollow=" + userid + "&cAction=" + action  , true);
    xmlhttp.send();
}
...
function ToggleNotification ( ) {
    ...
    if ( container.style.display === "none" ) {
        ...
        xmlhttp.open("GET", "/website/dashboard/notification_callback.php", true);
        xmlhttp.send();
    } else {
...
function CallbackSearch ( ) {
    let container = document.getElementById('action_search_preview_container');
    let text = document.getElementById('d_searchbar').value;
    ...
    xmlhttp.open("GET", "/website/dashboard/search_callback.php?cSearchText=" + text, true);
    xmlhttp.send();
}

function DisplaySearchResults( text, style ) {
    let container = document.getElementById('action_search_results_wrapper');
    ...
    xmlhttp.open("GET", "/website/dashboard/search_callback.php?cSearchText=" + text + "&cStyle=" + style, true);
    xmlhttp.send();
...
function ToggleModal ( image ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/user/image_callback.php?cImage=" + image , true);
    xmlhttp.send();
}
...
function ToggleUserModal ( user, id, type ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/user_modal_callback.php?cUser=" + user + "&cId=" + id + "&cType=" + type , true);
    xmlhttp.send();
}
...
function WriteComment( elem, type, reload ) {
    ...
    if ( value !== "" ) {
        ...
        xmlhttp.open("GET", "/website/dashboard/comment_callback.php?cComment=" + value + "&cElem=" + elem + "&cType=" + type, true);
        xmlhttp.send();
    } else {
        textarea.value = "";
    }
...
function Like( elem, type, status, reload ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/like_callback.php?cElem=" + elem + "&cType=" + type + "&cStatus=" + status, true);
    xmlhttp.send();
...
function CallElementInformation ( elem, type, reload ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/element_information_callback.php?cElem=" + elem + "&cType=" + type + "&cReload=" + reload, true);
    xmlhttp.send();
}
...
function LoadIndex ( specialpage ) {
    ...
    xmlhttp.open("GET", "/website/index_callback.php?sLogin=" + login + "&sRegister=" + register + "&sInformation=" + information + "&sHeader=" + header , true);
    xmlhttp.send();
}
...
function uploadProfileImage(that) {
    ...
    xmlhttp.open("POST", "/website/essentials/image_upload_callback_silent.php", true);
    xmlhttp.send(data);
}
...
function SaveProfileImage() {
    ...
    xmlhttp.open("POST", "/website/essentials/image_upload_callback.php", true);
...
function CallProfileForm ( status, userid ) {
    ...
    xmlhttp.open("GET", "/website/complete/profile_form_callback.php?cPage=" + status + "&cUserId=" + userid, true);
    xmlhttp.send();
}
...
function PreviewCities () {
    ...
    xmlhttp.open("GET", "/website/complete/search_callback.php?cSearch=" + search + "&cCountry=" + country, true);
    xmlhttp.send();
}
...
function PreviewTopUser () {
    ...
    xmlhttp.open("GET", "/website/complete/profile_form_user_callback.php", true);
    xmlhttp.send();
}
...
function CallbackSettings ( page ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/settings/settings_callback.php?cPage=" + page, true);
    xmlhttp.send();
}
...
function CallbackEdit ( identifier, index ) {
    ...
    xmlhttp.open("GET", "/website/dashboard/settings/edit_callback.php?cIndex=" + index, true);
    xmlhttp.send();
}
...
function SaveSettings( form, event, index ) {
    ...
    xmlhttp.open("POST", "/website/dashboard/settings/settings_save_callback.php", true);
    xmlhttp.send(formData);
...
function CheckUrlName() {
    ...
    xmlhttp.open("POST", "/website/dashboard/settings/check_url_callback.php?cUrlName=" + name, true);
    xmlhttp.send();
...
function CheckEmail() {
    ...
    xmlhttp.open("POST", "/website/dashboard/settings/check_email_callback.php?cEmail=" + email, true);
    xmlhttp.send();
}
...
function CheckMobile() {
    ...
    xmlhttp.open("POST", "/website/dashboard/settings/check_mobile_callback.php?cMobile=" + mobile, true);
    xmlhttp.send();
}
...
function SaveCity( city, lat, long ) {
    ...
    xmlhttp.open("GET", "/website/complete/city_information_callback.php?cCity=" + city, true);
    xmlhttp.send();
}
