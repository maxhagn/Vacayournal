...
function GetProfilePicture ( $cUserId, $database ) {
    ...
    if ($profile_image = $database->prepare('SELECT path FROM images WHERE user_id=? AND gallery=? ORDER BY id DESC LIMIT 1')) {
        ...
        if ( $ProfilePicturePath == "" ) {
            $ProfilePicturePath = "/website/resources/images/nouser.svg";
        } else {
            $ProfilePicturePath = "/website/" . $ProfilePicturePath;
        }
    }
                    ...
                    <div class="row s_show_comment">
                        <div class="col-sm-12">
                            <div class="row start-sm">
                                ...
                                <div class="col-sm-10 h_padding_vertical"><b><a href="/website/dashboard/index.php?cUserId=${cCommentUserId}">${cCommentUser}</a></b>&nbsp;${cCommentText}</div>
                            </div>
...
EOF;
    ...
    if ( $cElementComments > 3 ) {
        ...
        <div class="row start-xs s_element_comments">
            <div class="col-xs-10"><b><a href="/website/dashboard/element.php?cId=${cElementId}&cType=${cElementType}">Alle ${cElementComments} Kommentare ansehen</a></b></div>
        </div>
EOF;
    }
        ...
        <div class="row center-xs middle-xs">
            <div class="col-xs-12">
                ...
                <div class="row s_footer_buttons center-xs">
                    <div class="col-xs-6">
                        <a href='/website/index.php?sSpecial=r'">Registrieren</a>
                        <a href='/website/index.php?sSpecial=l'">Anmelden</a>
                        <a href='/website/help/information'">Informationen</a>
                        <a href='/website/converter'">Währungsrechner</a>
                        <a href='/website/map'">TomTom Karte</a>
                        <a href='/website/policies/#imprint'">Impressum</a>
                        <a href='/website/help/about'">Über Uns</a>
                        <a href='/website/developer/api'">Entwickler</a>
                        <a href='/website/developer/career'">Karriere</a>
                        <a href='/website/policies/'">Datenschutz</a>
                        <a href='/website/policies/#cookies_heading'">Cookies</a>
                        <a href='/website/help'">Hilfe</a>
                        <a href='/website/help/questions/#questions_mail'">Kontaktiere Uns</a>
                        <a href='/website/help/questions/#questions_report'">Rechtwidriges Verhalten</a>
                        <a href='/website/help/questions/#questions_error'">Fehlermeldungen</a>
