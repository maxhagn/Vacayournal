...
$cSearchText = "";
if ( isset($_SESSION['cSearchText']) ) {
    $cSearchText = $_SESSION['cSearchText'];
}
...
<main class="s_dashboard">
    <div class="container">
        <div class="row center-xs">
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-3" id="action_search_results_wrapper" style="text-align: left">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <select class="select-css select-css-small" title="Wähle das Land in dem du wohnst aus." name="new_country" id="new_country">
                            <option selected='selected' value='user'> Beliebig</option>
                            <option value='user'> Personen</option>
                            <option value='user'> Land</option>
                            <option value='user'> Beiträge</option>
                            <option value='user'> Kommentare</option>
                        </select>
                    </div>
                </div>
...
<script>
    ...
    DisplaySearchResults( '${cSearchText}', '1' );
