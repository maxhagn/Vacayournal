...
<main class="s_index_container s_dataprotection m_container_to_page_bottom">
    <div class="container h_padding_vertical">
        <div class="row center-xs">
            <div class="col-xs-6 start-xs">
                <h1 id="dataprotection_heading">Datenschutzerklärung</h1>
                <h2>Datenschutz</h2>
                ...
                <p>In der Regel werden Webserver-Logfiles zwei Wochen gespeichert und danach automatisch gelöscht. Wir
                    ...
                    Verhalten
                    eingesehen werden.</p>
                <h2 id="cookies_heading">Cookies</h2>
